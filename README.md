...
1. Clone the repository:
   ```bash
   git clone [[https://github.com/RamazanKaratut/RNN-Sine-Wave-Prediction.git](https://github.com/RamazanKaratut/Time-Series-Prediction-using-SimpleRNN/edit/main/README.md)]([https://github.com/RamazanKaratut/RNN-Sine-Wave-Prediction.git](https://github.com/RamazanKaratut/Time-Series-Prediction-using-SimpleRNN/edit/main/README.md))
